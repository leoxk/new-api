	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				topupRoute := selfRoute.Group("")
				topupRoute.Use(middleware.B2BTopUpOnly())
				{
					topupRoute.GET("/topup/info", controller.GetTopUpInfo)
					topupRoute.GET("/topup/self", controller.GetUserTopUps)
					topupRoute.POST("/topup", middleware.CriticalRateLimit(), controller.TopUp)
					...
					topupRoute.POST("/stripe/amount", controller.RequestStripeAmount)
					topupRoute.POST("/paypal/amount", controller.RequestPayPalAmount)
					topupRoute.POST("/paypal/pay", middleware.CriticalRateLimit(), controller.RequestPayPalPay)
					topupRoute.POST("/creem/pay", middleware.CriticalRateLimit(), controller.RequestCreemPay)
					topupRoute.POST("/waffo/amount", controller.RequestWaffoAmount)
					topupRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), controller.RequestWaffoPay)
					topupRoute.POST("/waffo-pancake/amount", controller.RequestWaffoPancakeAmount)
					topupRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), controller.RequestWaffoPancakePay)
				}
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/topup/refund-record", controller.AdminRecordCompletedTopUpRefund)
