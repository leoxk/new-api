...
3. GPT 文本分别覆盖 input、cached input、cache write、output、reasoning并验证标准外部客户 `b2b=0.3`；DeepSeek 覆盖 cache hit/miss/output并验证官方 base rate × `b2b-deepseek=1.10`；GPT Image 覆盖每个开放 size/quality 组合并验证 `b2b=0.3`。
