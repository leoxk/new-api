...
func migrateDB() error {
	...
	if err := backfillB2BRedemptionUsageSnapshots(); err != nil {
		return err
	}
	return nil
}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&CodexCapacitySnapshot{}, "CodexCapacitySnapshot"},
		{&CodexResetCredit{}, "CodexResetCredit"},
		{&CodexResetOperation{}, "CodexResetOperation"},
	}
